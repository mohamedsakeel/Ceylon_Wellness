        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Eggs = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MacroPreference = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    wheyproteinpref = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    mealintakepref = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    macropref = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NutritionQuantities", x => x.Id);
                    table.ForeignKey(
